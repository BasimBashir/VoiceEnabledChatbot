...
4. After performing above steps and you received no error between them now you can unzip
   tar.gz files by using winrar or by cmd command.
	...
	(b). If you want to use cmd open Windows file Explorerthen goto the root folder 	             of the application which will be /voicebot. Click on the directory toolbar 	             and write cmd and hit enter. After that put command 
...
5. Now from your IDE goto the the backend.py and run. you will see a 127.0.0.1 link    showing. Click this link and you wil be redirected to the browser. Enjoy the App    Now!!!